...
with open('/nas/longleaf/home/jsikder/schriderlab/ignored/phylo1/nointro.draw') as outfile:
    outfile.write(ts.draw_text())
with open('/nas/longleaf/home/jsikder/schriderlab/ignored/phylo1/nointro.stats') as outfile:
    outfile.write(ts)