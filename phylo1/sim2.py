...
def ancestrySim(seqlength, randomseed):
    ...
    #speciesTree.add_mass_migration(time=0.1*time_units, source="Dsantomea", dest="Derecta", proportion=.1)
...
ts.write_fasta('/nas/longleaf/home/jsikder/schriderlab/ignored/phylo1/nointro.fasta')
def write_output():
    with open('/nas/longleaf/home/jsikder/schriderlab/ignored/phylo1/nointro.draw', "w+") as outfile:
