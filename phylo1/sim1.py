...
ts.write_fasta('/nas/longleaf/home/jsikder/schriderlab/ignored/phylo1/aintro.fasta')
def write_output():
    with open('/nas/longleaf/home/jsikder/schriderlab/ignored/phylo1/aintro.draw', "w+") as outfile:
